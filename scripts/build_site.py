...
MANUAL_VACANCY_FALLBACKS: dict[str, dict[str, Any]] = {
    ...
    "u031": {
        "source_url": "https://spbguga.ru/sveden/vacant/",
        "message": (
            "Данные вручную приведены к стандартному формату из официальной таблицы "
            "вакантных мест СПбГУ ГА."
        ),
        "columns": STANDARD_COLUMNS,
        "rows": [
            ["38.03.01", "Экономика", "", "Высшее образование — бакалавриат", "1", "очная", "1", "109"],
            ["38.03.02", "Менеджмент", "", "Высшее образование — бакалавриат", "1", "очная", "2", "80"],
            ["38.03.02", "Менеджмент", "", "Высшее образование — бакалавриат", "2", "очная", "1", "79"],
            ["38.03.02", "Менеджмент", "", "Высшее образование — бакалавриат", "3", "очная", "0", "79"],
            ["38.03.02", "Менеджмент", "", "Высшее образование — бакалавриат", "4", "очная", "0", "80"],
            ["38.03.02", "Менеджмент", "", "Высшее образование — бакалавриат", "5", "очная", "0", "80"],
            ["20.03.01", "Техносферная безопасность", "", "Высшее образование — бакалавриат", "1", "очная", "13", "0"],
            ["38.04.01", "Экономика", "", "Высшее образование — магистратура", "1", "очная", "0", "25"],
            ["38.04.02", "Менеджмент", "", "Высшее образование — магистратура", "1", "очная", "0", "49"],
            ["38.04.02", "Менеджмент", "", "Высшее образование — магистратура", "2", "очная", "0", "49"],
            ["38.04.08", "Финансы и кредит", "", "Высшее образование — магистратура", "1", "очная", "0", "21"],
            ["38.04.08", "Финансы и кредит", "", "Высшее образование — магистратура", "2", "очная", "0", "22"],
            ["20.04.01", "Техносферная безопасность", "", "Высшее образование — магистратура", "1", "очная", "5", "0"],
            ["20.04.01", "Техносферная безопасность", "", "Высшее образование — магистратура", "2", "очная", "4", "0"],
            ["25.05.05", "Эксплуатация воздушных судов и организация воздушного движения", "", "Высшее образование — специалитет", "1", "очная", "10", "0"],
            ["25.05.05", "Эксплуатация воздушных судов и организация воздушного движения", "", "Высшее образование — специалитет", "2", "очная", "10", "0"],
            ["25.05.05", "Эксплуатация воздушных судов и организация воздушного движения", "", "Высшее образование — специалитет", "3", "очная", "10", "0"],
            ["25.05.05", "Эксплуатация воздушных судов и организация воздушного движения", "", "Высшее образование — специалитет", "4", "очная", "10", "0"],
            ["25.05.05", "Эксплуатация воздушных судов и организация воздушного движения", "", "Высшее образование — специалитет", "5", "очная", "20", "0"],
            ["25.05.05", "Эксплуатация воздушных судов и организация воздушного движения", "", "Высшее образование — специалитет", "6", "очная", "15", "0"],
            ["25.05.04", "Летная эксплуатация и применение авиационных комплексов", "", "Высшее образование — специалитет", "1", "очная", "20", "0"],
            ["25.05.04", "Летная эксплуатация и применение авиационных комплексов", "", "Высшее образование — специалитет", "2", "очная", "20", "0"],
            ["25.05.04", "Летная эксплуатация и применение авиационных комплексов", "", "Высшее образование — специалитет", "3", "очная", "20", "0"],
            ["25.05.04", "Летная эксплуатация и применение авиационных комплексов", "", "Высшее образование — специалитет", "4", "очная", "20", "0"],
            ["25.05.04", "Летная эксплуатация и применение авиационных комплексов", "", "Высшее образование — специалитет", "5", "очная", "30", "0"],
            ["25.05.04", "Летная эксплуатация и применение авиационных комплексов", "", "Высшее образование — специалитет", "6", "очная", "20", "0"],
        ],
    },
}
